...
<body>
		...
		<div class="section-browse">
			<h2>Browsed Genres : ${genre}</h2>
			<c:forEach items="${foundAlbum}" var="myAlbum">
				<div style="float:left; width:150px">
					<c:url var="albumUrl" value="Details?albumId=${myAlbum.albumId}" />
					<img alt="Album art of album : ${detailedAlbum.title}" src="../resources/resources/img/placeholder.gif"></img><br/><br/>
					<h4><a href="${albumUrl}"><c:out value="${myAlbum.title}" /></a></h4>
				</div>
			</c:forEach>
		</div>
